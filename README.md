...
`FullBlur`, `PartialBlur`, `FormPosition`, `BackgroundImageAlignment`, `ThemeColor`, `ScreenPadding`, `Font`, `HourFormat`, `ForceRightToLeft`, `TranslateUsernamePlaceholder` and many more!  
