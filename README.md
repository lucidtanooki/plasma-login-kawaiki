...
[Download the tar archive from opendesktop](https://www.pling.com/p/1312658/) and extract the contents to the theme directory of SDDM *(change the path for the downloaded file if necessary)*:
```
